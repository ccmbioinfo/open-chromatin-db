...
filename = '/home/samfeng/open-chromatin-db/public/files/All-Tracks.bed'
...
with open(filename) as f:
  ...
  for key, value in dictionary.items(): 
    ...
    gff_path = project_root + 'gff/' + gff_filename
    file = open(gff_path, 'w')
    columns = [constant_keys[0], 'period', 'type', constant_keys[1], constant_keys[2], value, 'plus', 'period', 'period']
